...
bool loadPrograms(const std::string & basepath) {
    ...
    std::string vshader = "shaders/vertexshader.glsl"; // basepath + "shaders/vertexshader.glsl"
    std::string fshader_light = "shaders/fragmentshader_dirlight.glsl";  // basepath + "shaders/fragmentshader_dirlight.glsl"
    std::string fshader_color = "shaders/fragmentshader_color.glsl"; // basepath + "shaders/fragmentshader_color.glsl"
    std::string fshader_quad = "shaders/diffuse_nolight.glsl";  // basepath + "shaders/diffuse_nolight.glsl"
